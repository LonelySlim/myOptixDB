...
int main(){
    ...
    inputfile = fopen("file_q4dot3.csv", "r");
    ...
    outputfile1 = fopen("outputfile_rtscan_q4dot3.txt", "wb");
    ...
    // printf("%lf %d %d %d %d %d %d", outputdata_avg[0][0], outputdata_group[0][0], outputdata_group[1][0], outputdata_group[2][0], outputdata_rtscan[0][0], outputdata_rtscan[1][0], outputdata_rtscan[2][0]);
