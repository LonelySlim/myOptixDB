...
int main(){
    ...
    outputdata_rtscan[3] = (uint32_t *)malloc(N * sizeof(uint32_t));
    ...
    inputfile = fopen("file_q4dot2.csv", "r");
    ...
    outputfile1 = fopen("outputfile_rtscan_q4dot2.txt", "wb");
    ...
    // printf("%lf %d %d %d %d %d %d %d", outputdata_avg[0][0], outputdata_group[0][0], outputdata_group[1][0], outputdata_group[2][0], outputdata_rtscan[0][6001214], outputdata_rtscan[1][6001214], outputdata_rtscan[2][0], outputdata_rtscan[3][0]);
    ...
    fwrite(outputdata_rtscan[3], sizeof(uint32_t), N, outputfile);
    ...
    fwrite(outputdata_rtscan[3], sizeof(uint32_t), N, outputfile1);
